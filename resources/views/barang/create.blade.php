...
<div class="container mt-4">
    <h2 class="s" style ="color: #2d7081; font-weight: bold; font-size: 36px; text-align: center;">Tambah Data Barang</h2>
    ...
    <form action="{{ url('/barang') }}" method="POST">
        ...
        <button type="submit" class="btn submit-button submit-button:hover, restart-button:hover">Simpan</button>
